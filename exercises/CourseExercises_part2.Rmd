...
On the course website, you will find file [whale_selenium.txt](https://raw.githubusercontent.com/MichielNoback/R_data_analysis_and_visualization/master/presentations/data/whale_selenium.txt). You could download it into your working directory manually or use `download.file()`, but you can also read it directly using `read.table()` as shown here.
